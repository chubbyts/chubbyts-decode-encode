  ...
  test('prettyPrint: true', async () => {
    ...
    expect(encoder.encode(data)).toMatchInlineSnapshot(`
      ...
      <json:object xsi:schemaLocation="http://www.datapower.com/schemas/json jsonx.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:json="http://www.ibm.com/xmlns/prod/2009/jsonx">
        ...
        <json:null name="search"></json:null>
      ...
      A f&#228;ncy Name
            ...
            <json:object>
              ...
              <json:object name="treeValues">
                <json:object name="key1">
                  <json:number name="key11">3</json:number>
                  <json:number name="key12">4</json:number>
                </json:object>
              </json:object>
              <json:number name="progress">24.7</json:number>
              <json:boolean name="active">true</json:boolean>
              <json:string name="parent">id1</json:string>
              <json:string name="_type">item</json:string>
              <json:object name="_links">
                <json:object name="read">
            ...
            <json:object>
              ...
              <json:object name="treeValues">
                <json:object name="key1">
                  <json:number name="key11">3</json:number>
                  <json:number name="key12">4</json:number>
                  <json:number name="key13">7</json:number>
                </json:object>
              </json:object>
  ...
  test('with another data set', async () => {
    ...
    expect(
      ...
      <json:array xsi:schemaLocation="http://www.datapower.com/schemas/json jsonx.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:json="http://www.ibm.com/xmlns/prod/2009/jsonx">
        <json:object>
          <json:null name="key1"></json:null>
          <json:array name="key10">
            <json:array>
              <json:object>
                <json:null name="key1"></json:null>
                <json:null name="key2"></json:null>
                <json:boolean name="key3">true</json:boolean>
                <json:boolean name="key4">false</json:boolean>
                <json:number name="key5">3</json:number>
                <json:number name="key6">3.3</json:number>
                <json:string name="key7">value7</json:string>
                <json:array name="key8">
                  ...
                  <json:number>3.3</json:number>
                  <json:string>value7</json:string>
                </json:array>
